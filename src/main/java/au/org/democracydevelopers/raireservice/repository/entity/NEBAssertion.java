...
public class NEBAssertion extends Assertion  {
   ...
   */
  @Override
  public au.org.democracydevelopers.raire.assertions.Assertion makeRaireAssertion(List<String> candidates) throws RaireServiceException {
      ...
      if (winnerIndex != -1 && loserIndex != -1 && assumedContinuing.isEmpty()) {
         ...
         throw new RaireServiceException(new RaireServiceError.ErrorRetrievingAssertions()) ;
      }
